#!/bin/bash -e
if [ "$1" == "-h" ]; then
  echo "Usage: `basename $0` version gpu-id(s) data-path train-path [trainer-args] [--host=EXTERNAL_IP]"
  echo "Example: `basename $0` 0.1 0,1 /data/huggingface/ ~/unsloth --host=10.2.23.35"
